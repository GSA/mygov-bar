...
files = [ 'cs/models/tag', 'cs/models/page', 'cs/models/comment', 'cs/models/search', 'cs/views/mini', 'cs/views/related', 'cs/views/feedback', 'cs/views/hidden', 'cs/views/search', 'cs/views/tags', 'cs/views/expanded', 'cs/router', 'cs/xd', 'cs/crossdomain', 'cs/init' ]
