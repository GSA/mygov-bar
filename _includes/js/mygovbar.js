(function() {
  ...
  MyGovBar.Models.Page = (function(_super) {
    ...
    function Page() {
      ...
      this.hasRelated = __bind(this.hasRelated, this);
    ...
    Page.prototype.initialize = function() {
      ...
      return this.on('change:tag_list', this.renderTags);
    };
    ...
    Page.prototype.hasRelated = function() {
      return this.get('related').length > 0;
    };

    Page.prototype.initPolling = function() {
      if (!this.hasRelated()) {
        return this.poller = setInterval(this.poll, 5000);
      }
    };

    Page.prototype.stopPolling = function() {
      clearInterval(this.poller);
      return this.poller = {};
    };

    Page.prototype.poll = function() {
      var _this = this;
      return this.fetch({
        success: function() {
          if (!_this.hasRelated()) {
          ...
          _this.stopPolling();
          return _this.maybeRender();
        }
      });
    };

    Page.prototype.renderRelated = function() {
      if (Backbone.history.fragment !== "related") {
        return;
      }
    ...
    Page.prototype.renderTags = function() {
      if (Backbone.history.fragment !== "tags") {
        return;
      }
  ...
  MyGovBar.Views.Feedback = (function(_super) {
    ...
    Feedback.prototype.render = function() {
      ...
      this.$el.html(MyGovBar.Templates.feedback());
    ...
    Feedback.prototype.saveRating = function(value, event) {
  ...
  MyGovBar.Views.Mini = (function(_super) {
    ...
    Mini.prototype.saveRating = function(value, event) {
      return this.model.save({
        rating: value
      });
    };
    ...
    Mini.prototype.minify = function(e) {
      return MyGovBar.router.go('mini', e);
    };
  ...
  MyGovBar.Views.Related = (function(_super) {
    ...
    Related.prototype.render = function() {
      if (this.model.hasRelated()) {
        this.$el.html(MyGovBar.Templates.related(this.model.toJSON()));
      } else {
        this.$el.html(MyGovBar.Templates.loading_related());
      }
      MyGovBar.CrossDomain.sendHeight();
      return this;
    };
  ...
  MyGovBar.Views.Search = (function(_super) {
    ...
    Search.prototype.render = function() {
      return this.$el.html(MyGovBar.Templates.search());
    };
  ...
  MyGovBar.Views.SearchResult = (function(_super) {
    ...
    SearchResult.prototype.render = function() {
      ...
      this.$el.html(MyGovBar.Templates.search_result({
  ...
  MyGovBar.Views.Tags = (function(_super) {
    ...
    Tags.prototype.render = function() {
      ...
      this.$el.html(MyGovBar.Templates.tags({
  ...
  CrossDomain = (function() {
    ...
    CrossDomain.prototype.hash = document.location.hash;

    CrossDomain.prototype.allowed_params = ['tabs', 'url'];
    ...
    function CrossDomain() {
      ...
      XD.receiveMessage(this.recieve, MyGovBar.config.parent_url);
    ...
    CrossDomain.prototype.send = function(msg) {
      return XD.postMessage(msg, MyGovBar.config.parent_url);
    };
    ...
    CrossDomain.prototype.setConfig = function(key, value) {
      if (_.indexOf(this.allowed_params, key) === -1) {
        return;
      }
      if (key === "url") {
        key = "parent_url";
      }
      return MyGovBar.config[key] = value;
    };
